        ...
        <div className="assignment border mb-3">
          ...
          <div className="col d-flex justify-content-between align-items-center border-0">
            <div className="pt-3 pb-3">
              ...
              {assignment.type === 'Food/Drink' && assignment.status === 'Assigned' && assignment.recipeLink && <div><a href={`${assignment.recipeLink}`} className="text-info">Link to recipe<i className="ml-2 fa fa-link"></i></a></div>}
            </div>
